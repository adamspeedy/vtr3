...
public:
    ...
    ROS2BagExtractor(const std::string& bag_path) : bag_path_(bag_path) {
        std::string db_path = bag_path + "/edges_0.db3";
    ...
    struct MessageData {
        int64_t timestamp;
        vtr_pose_graph_msgs::msg::Edge data;
    };
    ...
    std::vector<MessageData> extract_messages(int topic_id = -1, const std::string& topic_name = "") {
        ...
        rclcpp::Serialization<vtr_pose_graph_msgs::msg::Edge> serialization;
        ...
        while ((rc = sqlite3_step(stmt)) == SQLITE_ROW) {
            ...
            vtr_pose_graph_msgs::msg::Edge msg;
...
int main(int argc, char** argv) {
    ...
    auto messages = extractor.extract_messages(-1, "edges");
